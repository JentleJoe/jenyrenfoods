          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-16">
            {contactInfo.map((info, index) => (
              <div key={index} className="text-center">
                ...
                <h3 className="font-semibold text-brown-900 mb-2">{info.title}</h3>
          ...
          <div className="bg-white rounded-3xl shadow-lg overflow-hidden">
            ...
            <div className="p-6 bg-gradient-to-r from-cream-50 to-honey-50">
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6 text-center">
                <div>
                  <h3 className="font-semibold text-brown-900 mb-2">Address</h3>
                  <p className="text-brown-600">Tom Adigwe Street Off DLA Road, Asaba, Delta State</p>
                </div>
                <div>
                  <h3 className="font-semibold text-brown-900 mb-2">Phone / WhatsApp</h3>
                ...
                <div>
                  <h3 className="font-semibold text-brown-900 mb-2">Hours</h3>
